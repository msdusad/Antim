...
class Module implements AutoloaderProviderInterface {
    ...
    public function getServiceConfig() {
        return array(
            ...
            'factories' => array(
                'PrePlanning\Model\PrePlanningTable' => function($sm) {
                ...
                'TableGateway' => function ($sm) {
                    ...
                    $resultSetPrototype->setArrayObjectPrototype(new Model\PrePlanning());
                    return new TableGateway('preplanning', $dbAdapter, null, $resultSetPrototype);
                },
                 'PrePlanning\Model\FormsTable' => function($sm) {
                ...
                'FormsTableGateway' => function ($sm) {
                 ...
                 'PrePlanning\Model\CheckListTable' => function($sm) {
                ...
                'CheckListTableGateway' => function ($sm) {
                 ...
                 ,
                 'PrePlanning\Model\LinksTable' => function($sm) {
