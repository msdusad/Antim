...
class ModuleOptions extends AbstractOptions
{
     ...
     * @var string
     */
    protected $loginWidgetViewTemplate = 'scn-social-auth\user\login.phtml';
    /**
     * @var string
     */
    protected $connectionsEntityClass = 'ScnSocialAuth\Entity\Connections';
    /**
     * @var string
     */
    protected $contactsEntityClass = 'ScnSocialAuth\Entity\ScnContacts';
    /**
     * @var boolean
     */
     ...
     * set user provider entity class
     *
     * @param  string $setContactsEntityClass
     * @return ModuleOptions
     */
    public function setScnContactsEntityClass($contactsEntityClass)
    {
        $this->contactsEntityClass = (string) $contactsEntityClass;
     ...
     * @return string
     */
    public function getScnContactsEntityClass()
    {
        return $this->contactsEntityClass;
    }
    /**
     * set user provider entity class
     *
     ...
     * @return ModuleOptions
     */
    public function setConnectionsEntityClass($connectionsEntityClass)
    {
        $this->connectionsEntityClass = (string) $connectionsEntityClass;
     ...
     * @return string
     */
    public function getConnectionsEntityClass()
    {
        return $this->connectionsEntityClass;
    }
