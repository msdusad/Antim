        ...
        foreach ($contactsids as $chunk) {
            ...
            if ($response && count($response)) {
                foreach ($response as $item) {
                    ...
                    $uc->location = (property_exists($item, 'description')) ? $item->location : "";
                    $uc->jobTitle = '';
                    $uc->home = '';
                    $uc->company = '';
                    $uc->birthday = '';
    ...
    function getUserActivity($stream) {
     ...
     function sendMessageById($params) {
       ...
       // $subject = $params['subject'];
        ...
        $parameters = array('user_id' => $ids,'text'=>$message);
        $response =  $this->api->get('direct_messages/new.json',$parameters);
